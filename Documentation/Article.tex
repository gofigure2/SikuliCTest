...
images on the dashboard, it becomes difficult to visualize which units are being
tested in a single test. In addition, CDash does not make the distinction
between simple syntax errors versus a complete test failure. These are
